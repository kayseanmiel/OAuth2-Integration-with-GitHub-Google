...
const Home = () => {
  const { user, loading, login, checkAuthStatus } = useAuth();
    ...
    <div className="container">
      <div className="home">
        <header className="hero">
          ...
          <p>Sign in with your Google or GitHub account to access your profile</p>
        </header>
        ...
        <div className="features">
          ...
          <div className="feature-grid">
            <div className="feature">
              ...
              <p>OAuth2 integration with Google and GitHub for secure login</p>
            </div>
            <div className="feature">
              <h3>👤 User Profiles</h3>
